## Source: https://gallery.technet.microsoft.com/scriptcenter/Disk-Space-Report-Excel-f727d54e
## hat ersteinmal nicht funktioniert... aber Zugriff auf Excel :)
...
$colComputers = get-content ".\Clientlist.txt"
