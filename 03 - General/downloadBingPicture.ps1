# Source https://gallery.technet.microsoft.com/scriptcenter/Get-from-Bing-d9643639#content


# Get-BingPicture -DownloadPath C:\TEMP\BingImages -Market de-DE -Index 18 -NumberOfImages 8 -Resolution 1920x1080 
# Get-BingPicture -DownloadPath C:\TEMP\BingImages -Market de-DE -Index 18 -NumberOfImages 8 -Resolution 1920x1080 -verbose -debug
